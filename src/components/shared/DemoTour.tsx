...
export default function DemoTour() {
  ...
  if (step == null || !current) {
    return (
      <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-[90] flex items-center gap-3 bg-[#0F2A1E] text-white rounded-full pl-5 pr-2 py-2 shadow-xl border border-[#5DCAA5]/40 max-w-[94vw] overflow-x-auto">
